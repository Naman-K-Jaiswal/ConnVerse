...
const UserProfile = () => {
  ...
  const handleAddSkill = () => {
    ...
    setEditingIndexSkills(0); // Start editing the newly added skill at index 0
  };
  

  //  Blog Posts Functionalities
  const [blogpostsBlogPosts, setBlogpostsBlogPosts] = useState(["hello", "Software Dev Seocond", "Software Dev","Software Dev", "Software Dev", "Software Dev Last", "Software Dev Last"," Software Dev Last", "Software"]);

  const [editingIndexBlogPosts, setEditingIndexBlogPosts] = useState(null);
  const editRefBlogPosts = useRef(null);

  const handleEditBlogPosts = (index) => {
    setEditingIndexBlogPosts(index);
    setTimeout(() => {
      if (editRefBlogPosts.current) {
        editRefBlogPosts.current.focus();
      }
    }, 0);
  };

  const handleSaveBlogPosts = (index) => {
    setEditingIndexBlogPosts(null);
  };

  const handleDeleteBlogPosts = (index) => {
    const newBlogposts = [...blogpostsBlogPosts];
    newBlogposts.splice(index, 1);
    setBlogpostsBlogPosts(newBlogposts);
  };

  const handleMoveUpBlogPosts = (index) => {
    if (index === 0) return; // Already at the top
    const newBlogposts = [...blogpostsBlogPosts];
    [newBlogposts[index], newBlogposts[index - 1]] = [newBlogposts[index - 1], newBlogposts[index]];
    setBlogpostsBlogPosts(newBlogposts);
  };

  const handleMoveDownBlogPosts = (index) => {
    if (index === blogpostsBlogPosts.length - 1) return; // Already at the bottom
    const newBlogposts = [...blogpostsBlogPosts];
    [newBlogposts[index], newBlogposts[index + 1]] = [newBlogposts[index + 1], newBlogposts[index]];
    setBlogpostsBlogPosts(newBlogposts);
  };

  const handleAddPostBlogPosts = () => {
    setBlogpostsBlogPosts(["New Post", ...blogpostsBlogPosts]);
    setEditingIndexBlogPosts(0); // Start editing the newly added post at index 0
  };
  ...
  const [achievements, setAchievements] = useState(["Achievement1", "Achievement2", "Achievement3", "Achievement4", "Achievement5", "Achievement6", "Achievement7", "Achievement8", "Achievement9", "Achievement10"]);

  const [editingIndexAchievements, setEditingIndexAchievements] = useState(null);
  const editRefAchievements = useRef(null);

  const handleEditAchievements = (index) => {
    setEditingIndexAchievements(index);
    setTimeout(() => {
      if (editRefAchievements.current) {
        editRefAchievements.current.focus();
      }
    }, 0);
  };

  const handleSaveAchievements = (index) => {
    setEditingIndexAchievements(null);
  };
  ...
  const editRefCredentialPost = useRef(null);
  ...
  const handleEditCredential = (index) => {
    ...
    const credentialToEdit = credentials[index];
    setNewCredential({
      post: credentialToEdit.post,
      organization: credentialToEdit.organization,
      from: credentialToEdit.from,
      to: credentialToEdit.to
    });
  };
  ...
  const handleMoveUpCredential = (index) => {
    if (index === 0) return; // Already at the top
    const newCredentials = [...credentials];
  ...
  const handleMoveDownCredential = (index) => {
    if (index === credentials.length - 1) return; // Already at the bottom
    const newCredentials = [...credentials];
    [newCredentials[index], newCredentials[index + 1]] = [newCredentials[index + 1], newCredentials[index]];
    setCredentials(newCredentials);
  };
  const handleSaveCredential = (index) => {
    let isValid = true;
    const errors = {};
    if (!newCredential.post || newCredential.post.trim() === "") {
      isValid = false;
      errors.post = "Cannot be empty";
    }
    if (!newCredential.organization || newCredential.organization.trim() === "") {
      isValid = false;
      errors.organization = "Cannot be empty";
    } else if (!/^https?:\/\//.test(newCredential.organization)) {
      isValid = false;
      errors.organization = "Must be a valid URL";
    }
    if (isValid) {
      if (editingCredentialIndex !== null) {
        const updatedCredentials = [...credentials];
        updatedCredentials[editingCredentialIndex] = { ...updatedCredentials[editingCredentialIndex], ...newCredential };
        setCredentials(updatedCredentials);
        setEditingCredentialIndex(null);
      } else {
  ...
  const [projects,setProjects] = useState([ 
    ...
    },
    {
      ...
      instructorname: "Instructor1",
      skills: ["Skill1", "Skill2", "Skill3"],
      description: "This is a project description. This is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description f10 lorem, ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos. loeem epsum , This is a project description. This is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description fThis is a project description f10 lorem, ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos. loeem epsum",
      from: "2019",
      to: "Present"
    },
  ])
  ...
  const editRefProjectName = useRef(null);
  ...
  const editRefProjectFrom = useRef(null);
  const editRefProjectTo = useRef(null);
  ...
  const handleEditProject = (index) => {
    ...
    setNewProject({
      ...
      instructorname: ProjectToEdit.instructorname,
      skills: ProjectToEdit.skills,
      description: ProjectToEdit.description,
      from: ProjectToEdit.from,
      to: ProjectToEdit.to
    }); 
  };
  const [errorMessagesProject,setErrorMessagesProject] = useState ([]);
  const setErrorsProject = (errors) =>{
    setErrorMessages([...errorMessagesProject, errors]);
  };
  ...
  const handleSaveProjets = (index) => {
    let isValid = true;
    const errors = {};
    if (!newProject.name || newProject.post.trim() === "") {
      isValid = false;
      errors.post = "Cannot be empty";
    }
    if (!newProject.instructorname || newProject.instructorname.trim() === "") {
      isValid = false;
      errors.organization = "Cannot be empty";
    } 
    if (isValid) {
  ...
  const editRefCourseName = useRef(null);
  ...
  const [errorMessagesCourse,setErrorMessagesCourse] = useState ([]);
  const setErrorsCourse = (errors) =>{
    setErrorMessagesCourse([...errorMessagesCourse, errors]);
  }
  ...
  const handleSaveCourse = (index) => {
    ...
    if (!newCourse.instructorname || newCourse.instructorname.trim() === "") {
      isValid = false;
      errors.instructorname = "Cannot be empty";
    } 
    if (isValid) {
      if (editCourseIndex !== null) {
        const updatedCourses = [...courses];
        updatedCourses[editCourseIndex] = { ...updatedCourses[editCourseIndex], ...newCourse };
  ...
  return (
    <>
      <div id="personalProfileMainDiv" className={showCredentialPopup|| showProjectPopup ||showCoursePopup ? 'dimmed' : ''}>
        
        {/* profileImageAndDetailDiv Section */}
        <div id="profileImageAndDetailDiv">
            <div id="backgroundProfileImageDiv">
                <img id="backgroundProfileImageImg" src={backgroundImage} alt="Background Img" />
              ...
              {isEditingProfileDescription ? (
                  <>
                      <textarea style = {{
                          ...
                          onChange={(e) => setEditedDescriptionProfileDescription(e.target.value)}
                      />
                      <DoneIcon
                          onClick={handleSaveClickProfileDescription}
                          style={{ position: 'relative', left: '0vw', cursor: 'pointer'}}
                      />
                  </>
              ) : (
                  <>
                      ...
                      <EditIcon
                          ...
                          style={{ position: 'relative', left: '57.5vw', cursor: 'pointer'}}
                      />
                  </>
              )}
          </div>
          <div id="userUsernameAndName">
            <p style={{fontSize:'2em'}}>{userid}</p>
        ...
        <div id="skillAndTopPostDiv">
          ...
          <div id="skillsDiv">
            <div id="skillHeading">
              ...
              <div id="addSkillIcon">
                <AddCircleIcon onClick={handleAddSkill} style={{fontSize: '30px', color:'black'}}/>
              </div>
            </div>
            <div id="skillList">
                  ...
                  skills.map((skill, index) => {
                    return (
                      <div key={index} id="skillItemX" >
                        <div contentEditable={editingIndexSkills === index} onBlur={() => setEditingIndexSkills(null)} ref={editRefSkills}>
                          {skill}
                        </div>
                        <div style={{display: 'flex', justifyContent: 'right', marginRight: '1vw'}}>
                          {editingIndexSkills !== index ? (
                            <div className="editIcons">
                              <EditIcon onClick={() => handleEditSkills(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}/>
                              <DeleteIcon onClick={() => handleDeleteSkills(index)} style={{fontSize: '20px', color:'black'}}/>
                              <ArrowUpwardIcon onClick={() => handleMoveUpSkills(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                              <ArrowDownwardIcon onClick={() => handleMoveDownSkills(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                            </div>
                          ) : (
                            <div className="editIcons">
                              <DoneIcon onClick={() => handleSaveSkills(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}></DoneIcon>
                            </div>
                          )}
                        </div>
                      </div>
          ...
          <div id="topPostDiv">
            <div id="topPostHeading">
              ...
              <div id="addTopPostIcon">
                <AddCircleIcon onClick={handleAddPostBlogPosts} style={{fontSize: '30px', color:'black'}}/>
              </div>
            </div>
            <div id="topPostList">
                  ...
                  blogpostsBlogPosts.map((blogpost, index) => {
                    return (
                      <div key={index} id="topPostItemX" >
                        <div contentEditable={editingIndexBlogPosts === index} onBlur={() => setEditingIndexBlogPosts(null)} ref={editRefBlogPosts}>
                          {blogpost}
                        </div>
                        
                        <div style={{display: 'flex', justifyContent: 'right', marginRight: '1vw'}}>
                          {editingIndexBlogPosts !== index ? (
                            <div className="editIcons">
                              <EditIcon onClick={() => handleEditBlogPosts(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}/>
                              <DeleteIcon onClick={() => handleDeleteBlogPosts(index)} style={{fontSize: '20px', color:'black'}}/>
                              <ArrowUpwardIcon onClick={() => handleMoveUpBlogPosts(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                              <ArrowDownwardIcon onClick={() => handleMoveDownBlogPosts(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                            </div>
                          ) : (
                            <div className="editIcons">
                              <DoneIcon onClick={() => handleSaveBlogPosts(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}></DoneIcon>
                            </div>
                          )}
                        </div>
                      </div>
          ...
          <div id="achievementsDiv">
            <div id="achievementHeading">
              ...
              <div id="addAchievementIcon">
                <AddCircleIcon onClick={handleAddAchievement} style={{fontSize: '30px', color:'black'}}/>
              </div>
            </div>
                  ...
                  achievements.map((achievement, index) => {
                    return (
                      <div key={index} id="achievementItemX" >
                        ...
                        <div contentEditable={editingIndexAchievements === index} onBlur={() => setEditingIndexAchievements(null)} ref={editRefAchievements}>
                          {achievement}
                        </div>
                        <div style={{display: 'flex', justifyContent: 'right', marginRight: '1vw'}}>
                          {editingIndexAchievements !== index ? (
                            <div className="editIcons">
                              <EditIcon onClick={() => handleEditAchievements(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}/>
                              <DeleteIcon onClick={() => handleDeleteAchievements(index)} style={{fontSize: '20px', color:'black'}}/>
                              <ArrowUpwardIcon onClick={() => handleMoveUpAchievements(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                              <ArrowDownwardIcon onClick={() => handleMoveDownAchievements(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                            </div>
                          ) : (
                            <div className="editIcons">
                              <DoneIcon onClick={() => handleSaveAchievements(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}></DoneIcon>
                            </div>
                          )}
                        </div>
                      </div>
                    ...
                    credentials.map((credential, index) => {
                      return (
                        <div key={index} id="credentialItemX" >
                          <div contentEditable ={editingCredentialIndex===index} onBlur={()=> setEditingCredentialIndex(null) } ref= {editRefCredentialPost} id="credentialItemPost">
                            {credential.post}
                          </div>
                          <div contentEditable ={editingCredentialIndex===index} onBlur={()=> setEditingCredentialIndex(null) } ref= {editRefCredentialOrganization} id="credentialItemOrganization">
                            {credential.organization}
                          </div>
                          <div contentEditable ={editingCredentialIndex===index} onBlur={()=> setEditingCredentialIndex(null) } ref= {editRefCredentialFromTo} id="credentialItemFromTo">
                            {credential.from} - {credential.to}
                          </div>
                          <div style={{display: 'flex', justifyContent: 'right', marginRight: '1vw'}}>
                          {editingCredentialIndex !== index ? (
                            <div className="editIcons">
                              <EditIcon onClick={() => handleEditCredential(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}/>
                              <DeleteIcon onClick={() => handleDeleteCredential(index)} style={{fontSize: '20px', color:'black'}}/>
                              <ArrowUpwardIcon onClick={() => handleMoveUpCredential(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                              <ArrowDownwardIcon onClick={() => handleMoveDownCredential(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                            </div>
                          ) : (
                              <div className="editIcons">
                                <DoneIcon onClick={() => handleSaveCredential(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}></DoneIcon>
                              </div>
                            )}
                          </div>
                        </div>
                ...
                projects.map((project, index) => {
                  return (
                    <div key={index} id="projectItemX" >
                      <div contentEditable={editProjectIndex===index} onBlur={()=> setEditProjectIndex(null) } ref= {editRefProjectName} id="credentialItemPost">
                        {project.name}
                      </div>
                      <div contentEditable={editProjectIndex===index} onBlur={()=> setEditProjectIndex(null) } ref= {editRefProjectInstructor} id="credentialItemOrganization">
                        {project.instructorname}
                      </div>
                      <div contentEditable={editProjectIndex===index} onBlur={()=> setEditProjectIndex(null) } ref= {editRefCredentialFromTo} id="credentialItemFromTo">
                        {project.from} - {project.to}
                      </div> 
                      <div contentEditable={editProjectIndex===index} onBlur={()=> setEditProjectIndex(null) } ref= {editRefProjectSkills} id="credentialItemFromTo">
                        {project.skills}
                      </div>
                      <div contentEditable={editProjectIndex===index} onBlur={()=> setEditProjectIndex(null) } ref= {editRefProjectDescription} id="credentialItemFromTo">
                      ...
                      <div style={{display: 'flex', justifyContent: 'right', marginRight: '1vw'}}>
                        {editProjectIndex !== index ? (
                          <div className="editIcons">
                            <EditIcon onClick={() => handleEditProject(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}/>
                            <DeleteIcon onClick={() => handleDeleteProject(index)} style={{fontSize: '20px', color:'black'}}/>
                            <ArrowUpwardIcon onClick={() => handleMoveUpProject(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                            <ArrowDownwardIcon onClick={() => handleMoveDownProject(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                          </div>
                        ) : (
                            <div className="editIcons">
                              <DoneIcon onClick={() => handleSaveProjets(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}></DoneIcon>
                            </div>
                          )}
                    </div>
                    </div>
                ...
                courses.map((course, index) => {
                  return (  
                    <div key={index} id="courseItemX" >
                      <div contentEditable={editCourseIndex===index} onBlur={()=> setEditCourseIndex(null) } ref= {editRefCourseName} id="credentialItemPost">
                        {course.coursename}
                      </div>
                      <div contentEditable={editCourseIndex===index} onBlur={()=> setEditCourseIndex(null) } ref= {editRefCourseInstructor} id="credentialItemOrganization">
                        {course.instructorname}
                      </div>
                      <div contentEditable={editCourseIndex===index} onBlur={()=> setEditCourseIndex(null) } ref= {editRefCourseDescription} id="credentialItemFromTo">
                        {course.description.split(' ').slice(0, 10).join(' ')}{course.description.split(' ').length > 10 ? '...' : ''}
                      </div>
                      <div contentEditable={editCourseIndex===index} onBlur={()=> setEditCourseIndex(null) } ref= {editRefCourseYear} id="credentialItemFromTo">
                        {course.year}
                      </div>
                      <div contentEditable={editCourseIndex===index} onBlur={()=> setEditCourseIndex(null) } ref= {editRefCourseSemester} id="credentialItemFromTo">
                        {course.semester}
                      </div>
                      <div style={{display: 'flex', justifyContent: 'right', marginRight: '1vw'}}>
                        {editCourseIndex !== index ? (
                          <div className="editIcons">
                            <EditIcon onClick={() => handleEditCourse(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}/>
                            <DeleteIcon onClick={() => handleDeleteCourse(index)} style={{fontSize: '20px', color:'black'}}/>
                            <ArrowUpwardIcon onClick={() => handleMoveUpCourse(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                            <ArrowDownwardIcon onClick={() => handleMoveDownCourse(index)} style={{fontSize: '20px', color:'black', marginLeft: '5px'}}/>
                          </div>
                        ) : (
                            <div className="editIcons">
                              <DoneIcon onClick={() => handleSaveCourse(index)} style={{fontSize: '20px', color:'black', marginRight: '5px'}}></DoneIcon>
                            </div>
                          )}
                      </div>
                    </div>
      ...
      {showCredentialPopup && (
        ...
        <h2 id= "credentialPopupHeading">{editingCredentialIndex !== null ? 'Edit Credential' : 'Enter Details'}</h2>
          <form onSubmit={handleAddCredentialSubmit} id = "credentialForm">
              ...
              <input
                ...
                onChange={handleInputChangeCredential}
              />
              <button type="submit" id="addNewCredBtn">Add Credential</button>
            </form>
      ...
      {showProjectPopup && ( 
        <div id="projectPopup">
          <h2 id= "projectPopupHeading">{editProjectIndex !== null ? 'Edit Project' : 'Enter Details'}</h2>
          <form onSubmit={handleAddProjectSubmit} id = "projectForm">
            ...
            <input
              ...
              onChange={handleInputChangeProject}
            />
            <button type="submit" id="addNewProjectBtn">Add Project</button>
          </form>
      ...
      {showCoursePopup && (
        <div id="coursePopup">
          <h2 id= "coursePopupHeading">{editCourseIndex !== null ? 'Edit Course' : 'Enter Details'}</h2>
          <form onSubmit={handleAddCourseSubmit} id = "courseForm">
            ...
            <input
              ...
              required
            />
            <button type="submit" id="addNewCourseBtn">Add Course</button>
          </form>
