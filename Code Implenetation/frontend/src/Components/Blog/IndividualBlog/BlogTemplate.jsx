...
const BlogTemplate = () => {
  ...
  const handleUpvote = async () => {
    console.log(id);
    try {
      const res = await fetch(`${process.env.BACKEND_URL}/blog/react/${id}`, {
        method: "POST",
        credentials: "include",
        headers: {
    ...
    const func = async () => {
      try {
        ...
        if (res.ok) {
          ...
          const response = await fetch(`${process.env.BACKEND_URL}/feed/add/tags`, {
            method: "POST",
            credentials: "include",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleComment = async () => {
    try {
      const res = await fetch(`${process.env.BACKEND_URL}/blog/comment/${id}`, {
        method: "POST",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleDelete = async () => {
    try {
      const res = await fetch(
        `${process.env.BACKEND_URL}/blog/compose/delete/${id}`,
        {
          method: "POST",
          credentials: "include",
          headers: {
