                            ...
                            <div key={blog._id} className="blogX" onClick={() => handleRedirect(blog.ID)}>
                                <div className="blogLeftHalfDiv">
                                    <div className="blogHeading">
                                        ...
                                        <div className="blogTitle" style={{ fontFamily: 'Roboto', fontWeight: 'bold', fontSize: '24px' }}>{blog.title}</div>
                                        <div className="blogUsername" style={{ fontFamily: 'Pacifico', fontSize: '20px' }}>{blog.authorname}</div>
                                        <div className="blogLastDate" style={{ fontFamily: 'Arial', fontSize: '14px', fontStyle: 'italic' }}>{getDaysAgo(blog.timestamp)}</div>
                                        <div className="blogTags" style={{ fontFamily: 'Montserrat', fontSize: '16px' }}>
        {blog.tags.map((tag, index) => (
            <div key={index} className="blogTagX" style={{ fontFamily: 'Montserrat', fontWeight: 'bold', fontSize: '14px' }}>{tag}</div>
        ))}
    </div>
                                    ...
                                    <div className="blogContent">
                                        <p>{blog.content.split(' ').slice(0, 80).join(' ')}{blog.content.split(' ').length > 100 ? '...' : ''}</p>
                                    </div>
                                </div>
